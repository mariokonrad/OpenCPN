...
public:
	...
	virtual int GetCOVRTablePoints(int)
	{
		return 0;
	}

	virtual int GetCOVRTablenPoints(int)
	{
		return 0;
	}

	virtual float* GetCOVRTableHead(int)
	{
		return (float*)NULL;
	}
...
public:
	...
	virtual void SetDefaults(void); // This will be called upon enabling a PlugIn via the user
									// Dialog
...
extern "C" DECL_EXP void SetCanvasContextMenuItemViz(int item, bool viz); // Temporarily change
																		  // context menu ptions
...
public:
	...
	char* att_array;
	chart::wxArrayOfS57attVal* attVal;
	int n_attr;
