...
class DECL_EXP ocpnDC // FIXME: redesign: do not support wxGLCanvas or wxDC, use polymorphism
{
	public:
	...
	private:
		...
		void DrawGLThickLine(double x1, double y1, double x2, double y2, wxPen pen, bool b_hiqual) const;
		void drawrrhelper(wxCoord x, wxCoord y, wxCoord r, double st, double et) const;
		void SetGLStipple() const;

		void GLDrawBlendData(
				wxCoord x,
				wxCoord y,
				wxCoord w,
				wxCoord h,
