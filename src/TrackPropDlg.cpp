	...
	: wxDialog(parent, id, title, pos, size, style)
{
	...
	m_panelBasic = new wxScrolledWindow(m_notebook1, wxID_ANY, wxDefaultPosition, wxDefaultSize,
	...
	m_panelAdvanced = new wxScrolledWindow(m_notebook1, wxID_ANY, wxDefaultPosition, wxDefaultSize,
										   wxTAB_TRAVERSAL);
